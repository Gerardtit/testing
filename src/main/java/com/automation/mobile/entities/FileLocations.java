...
public class FileLocations {
    ...
    public static String CONFIG_FILE_NAME = APPLICATION_DIRECTORY + "/app-config.json";
    ...
    public static String SCREENSHOT_DIRECTORY = APPLICATION_DIRECTORY + "/screenshots/";
