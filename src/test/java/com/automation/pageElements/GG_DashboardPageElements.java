...
//    @iOSXCUITFindBy(xpath="//XCUIElementTypeButton[@name=\"HOME\"]")
//    @iOSXCUITFindBy(iOSNsPredicate = "label == 'HOME' AND type == 'XCUIElementTypeButton' AND visible == 1")
...
//    @AndroidFindBy(uiAutomator = "//*[contains(@text,'HOME')]" )
    ...
    @AndroidFindBy(id = "cl_search_view_container")
    @iOSXCUITFindBy(xpath = "//*[@name='btnSearchBarViewButton'] | //*[@label=\"Scan\"]")
    ...
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name=\"lblHorizontalTitleCVCellTitle\"])[5]")
    ...
    @iOSXCUITFindBy(iOSNsPredicate = "label == 'Next' AND name == 'btnNext-Pick up tool tip'")
...
//    @iOSXCUITFindBy(xpath="//XCUIElementTypeButton[@name=\"SHOP\"]")
    ...
    @iOSXCUITFindBy(iOSNsPredicate = "label CONTAINS 'Delivery' or label CONTAINS 'Pickup' or label CONTAINS 'In-'")
    ...
    @iOSXCUITFindBy(iOSNsPredicate = "label BEGINSWITH 'Not Now'")
    public MobileElement notNowRating;
    ...
    @AndroidFindBy(id = "tv_salutation_header")
    public MobileElement clipYourDealsLabel;
    ...
    @AndroidFindBy(id = "tv_see_all")
    @iOSXCUITFindBy(accessibility = "btnSeeAllButtonTitle-Clip your deals")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[8][@label=\"View Rewards, 3 of 6\"]|//XCUIElementTypeTable/XCUIElementTypeButton[8]")
    public MobileElement myRewardsDrawer;


    @AndroidFindBy(xpath = "//android.widget.TextView[@content-desc='Button for Deals']")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeButton' AND name == 'View Deals'")
    public MobileElement dealsDrawer;

    @AndroidFindBy(xpath = "//android.widget.TextView[@content-desc='Button for Pharmacy']")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeButton' AND name == 'View Pharmacy'")
    public MobileElement pharmacyDrawer;

    @AndroidFindBy(xpath = "//android.widget.TextView[@content-desc='Button for FreshPass']")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeButton' AND name == 'View FreshPass'")
    public MobileElement freshPassDrawer;

    @AndroidFindBy(accessibility = "Button for Weekly Ad")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeButton' AND name contains 'View Weekly Ad'")
    ...
    @AndroidFindBy(accessibility = "Testing Sheet close")
    public MobileElement testingSheetClose;

    @iOSXCUITFindBy(accessibility = "Allow")
    public MobileElement allowNotificationPermissionPopup;

    @AndroidFindBy(accessibility = "MY LIST")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeButton' AND label == 'MY LIST' AND visible==1")
    ...
    @AndroidFindBy(xpath = "//android.widget.TextView[@content-desc='Pharmacy heading']")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeStaticText' AND name =='Pharmacy' AND label == 'Pharmacy'")
    public MobileElement pharmacyPageTitle;

    @AndroidFindBy(id = "freshPassCardView")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Enjoy free delivery & perks* with FreshPass™']")
    public MobileElement freshPassPageTitle;

    @AndroidFindBy(id = "tv_rewards_header")
    @iOSXCUITFindBy(accessibility = "Grocery Rewards; Spend rewards before they expire!")
    public MobileElement rewardsPageTitle;

    @AndroidFindBy(xpath = "//android.widget.ImageButton[@content-desc='Back']")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeNavigationBar[@name='Pharmacy']/XCUIElementTypeButton")
    public MobileElement backBtnInPharmacyServicesPage;

    @AndroidFindBy(accessibility = "Orders button")
    @iOSXCUITFindBy(iOSNsPredicate = "type == 'XCUIElementTypeStaticText' AND name =='Orders'")
    public MobileElement ordersModuleInSettings;

    @AndroidFindBy(id = "tv_shopping_mode")
    @iOSXCUITFindBy(iOSNsPredicate = "Grocery Rewards; Spend rewards before they expire!")
    public MobileElement shoppingMode;

    @AndroidFindBy(id = "tv_shopping_address")
    @iOSXCUITFindBy(iOSNsPredicate = "label CONTAINS[c] 'Delivery' or label CONTAINS[c] 'Pickup' or label CONTAINS[c] 'In-'")
    public MobileElement shoppingAddress;

    @AndroidFindBy(accessibility = "Cancel")
    public MobileElement clearTextSearchBar;

    @AndroidFindBy(xpath = "//*[contains(@content-desc,'Food Lot Fridays')]")
    @iOSXCUITFindBy(xpath = "//*[contains(@label,'Food Lot Fridays')]")
    public MobileElement foodLotBanner;

    @AndroidFindBy(xpath = "//*[@text='Meal Plans']")
    @iOSXCUITFindBy(xpath = "//*[contains(@name,'Deals')]//following-sibling::XCUIElementTypeButton[contains(@name,'Meal Plans')]")
    public MobileElement mealPlansHaloNavTab;
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeCell/XCUIElementTypeButton[contains(@label,'FreshPass,')]")
    public MobileElement freshPassIcon;

    @AndroidFindBy(xpath = "//*[@text='Rewards']")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeCell/XCUIElementTypeButton[contains(@label,'Rewards,')]")
    public MobileElement rewardsIcon;
}
