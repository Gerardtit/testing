...
public class StoresService extends RestService {
    ...
    public Result getListOfStores() {
        ...
        try {
            ...
            result.setStatusMsg("Get List Of Stores Failed with Exception :: " + e);
        }
    ...
    public Result getStoreDetail() {
        ...
        try {
            ...
            result.setStatusMsg("Get Store Detail Failed with Exception :: " + e);
        }
    ...
    public Result getStoreResolverHome() {
        ...
        try {
            ...
            result.setStatusMsg("Get  Store Resolver Home Failed with Exception :: " + e);
        }
