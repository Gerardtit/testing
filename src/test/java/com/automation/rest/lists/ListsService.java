...
public class ListsService extends RestService {
    ...
    public Result getMyList(String storeID) {
        ...
        try {
            ...
            result.setStatusMsg("Get My List Failed with Exception :: " + e);
        }
        return result;
    }
    ...
    public Result postMyListDeleteItem() {
        ...
        try {
            ...
            result.setStatusMsg("Post My List Delete Item Failed with Exception :: " + e);
        }
    ...
    public Result postAisleSort() {
        ...
        try {
            ...
            result.setStatusMsg("Post Aisle Sort Failed with Exception :: " + e);
        }
