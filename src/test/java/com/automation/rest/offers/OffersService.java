...
public class OffersService {
    ...
    private static final String GET_STORE_ID = "/abs/qa1pub/mobile/j4u/api/ecomgallery?storeId=%s&offerPgm=PD-CC";


    //Keeping Belo for backward compatiablity Please don't use it
...
//	protected String hostUrl = "https://www-%s.safeway.com";
    ...
    public OffersService(String banner) {
        this.HOST = String.format(HOST, new RestApiUtils().resolveBannerNameForHost(banner));
    }

    public Result getAllOffers(String storeID) {
        Result result = new Result();
        HttpRequest request = new HttpRequest();
        //String url = this.HOST  + "abs/qa1pub/mobile/j4u/api/ecomgallery?storeId=" + storeID + "&offerPgm=PD-CC";
        String url = this.HOST + String.format(GET_STORE_ID, storeID);
...
//                }
            ...
            result.setStatusMsg("Get All Offers Failed with Exception :: " + e);
        }
        return result;
    }
    ...
    public Result getCategory() {
        ...
        try {
            ...
            result.setStatusMsg("Get Category Failed with Exception :: " + e);
        }
    ...
    public Result getWeeklySpecials() {
        ...
        try {
            ...
            result.setStatusMsg("Get Weekly Specials Failed with Exception :: " + e);
        }
    ...
    public Result getOfferClip() {
        ...
        try {
            ...
            result.setStatusMsg("Get Offer Clip Failed with Exception :: " + e);
        }
    ...
    public ApiResponse.StoreSolver.Store getStoreDetails(String deliveryMode, String zipCode, String bannerName) {
        ...
        String userName = ThreadLocalHelper.testCaseData.get().get("USERNAME_CART_API");
        String password = ThreadLocalHelper.testCaseData.get().get("PASSWORD_CART_API");
    ...
    public ApiResponse.StoreSolver.Store getStoreDetails(String userName, String password, String deliveryMode, String zipCode, String bannerName) {
        Result result = new Result();
        HttpRequest request = new HttpRequest();
        ApiResponse.StoreSolver.Store desiredStore = null;
        AccessToken accessToken = new AccessToken(userName, password);
