...
public class UCAService extends RestService {
    ...
    public Result getHiddenCategories() {
        ...
        try {
            ...
            result.setStatusMsg("Get Hidden Categories Failed with Exception :: " + e);
        }
    ...
    public Result getListOfCategories() {
        ...
        try {
            ...
            result.setStatusMsg("Get List Of Categories Failed with Exception :: " + e);
        }
    ...
    public Result getPreferredStore() {
        ...
        try {
            ...
            result.setStatusMsg("Get Preferred Store Failed with Exception :: " + e);
        }
    ...
    public Result getUCAProfile() {
        ...
        try {
            ...
            result.setStatusMsg("Get UCA Profile Failed with Exception :: " + e);
        }
    ...
    public Result patchCommunicationPreferences() {
        ...
        try {
            ...
            result.setStatusMsg("patch Communication Preferences Failed with Exception :: " + e);
        }
    ...
    public Result patchUpdateCategoryPreference() {
        ...
        try {
            ...
            result.setStatusMsg("patch Update Category Preference Failed with Exception :: " + e);
        }
