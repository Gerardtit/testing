...
#    Then my account page is displayed
  ...
  @account
  Scenario: New contact phone number saved in my Account page should matches the contact phone number on checkout page
    Given user verify contact phone number is displayed
    When user click edit contact phone number on account page
    Then contact phone number edit window is displayed
    When user edit new contact phone number on account edit window
  ...
  @YRM-122 @YRM-135 @YRM-338 @Accountfeature
  Scenario: Validate Account feature by turning on and off isMyaccountfeatureEnabled flag
  #When user clicks developer settings
  #When turn "ON" newaccount feature
  ...
  #And relaunch the application
    ...
    And user verify phone number used in store is displayed
    And user verify email address is displayed on account page
    And user verify birthday  is displayed on account page
    And user scroll down
    And verify needhelp is displayed on account page
  #When turn "OFF" newaccount feature
  #Then kill the application
  #And relaunch the application
  #When go to member tab
  #And verify Wallet is displayed in place of Account
