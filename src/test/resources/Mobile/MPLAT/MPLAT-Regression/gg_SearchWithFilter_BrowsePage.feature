@gg_SearchWithFilter_BrowsePage
Feature: Validate Search with Filter in Home Page

  @unittest   #MMM-3995
  Scenario: Verify mediumBanner content with HTML tags in Browse page
  ...
  @unittest   #MMM-4048
  Scenario: Verify mediumBanner content with HTML tags in Landing page- Browse Page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
    Then select order type page is displayed
    ...
    Then verify MFA home screen is displayed
    When user click aisles tab on home page
    And scroll down for "Hooked on Freshness" carousel
  ...
  Scenario: Verify Medium banner CTA search deals with keyword in Browse page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
    Then select order type page is displayed
  ...
  @unittest   #MMM-4020  #test data is present in Shaws banner(zipcode-03885)
  Scenario: Verify Medium banner CTA search deals with keyword in browse page - landing page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
    Then select order type page is displayed
  ...
  @SwathiTestBrowse3844   #MMM-3844 #test data is present in shaws banner(Zipcode- 03885)
  ...
  @SwathiTestBrowse4022 #MMM-4022 #test data is present in shaws banner(Zipcode- 03885)
  Scenario: Verify Medium banner CTA search deals with keyword in home page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
  ...
  @SwathiTestBrowse4023 #MMM-4023 #test data is present in shaws banner(Zipcode- 03885)
  Scenario: Verify Medium banner CTA search deals with keyword in home page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
  ...
  @SwathiTestBrowse3845 #MMM-3845 #test data is present in shaws banner(Zipcode- 03885)
  Scenario: Verify Medium banner CTA search deals with keyword in home page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
  ...
  Scenario: Verify Medium banner CTA search with Filter with keyword in browse page
    When click on NewSignup Api for OTP
    Then zipcode page is displayed
    When user enters "zipcode" in zipcode page
    Then select order type page is displayed
