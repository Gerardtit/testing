...
#    When user clicks contact on checkout page
 ...
 #   Then get order date from order confirmation page
  ...
  @regression
  Scenario: Verify back arrow navigation from Order Details screen to Order history screen for Delivery
 ...
 #  # Then user clicks on slotselction screen
    ...
    When click on Order button
    Then verify Order history page is displayed
    When user clicks on View Details or Track Order section in Order history page for Delivery
 ...
 #  # Then user clicks on slotselction screen
    ...
    When click on Order button
    Then verify Order history page is displayed
    When user clicks on View Details or Track Order section in Order history page for DUG
    Then verify Order details page is displayed
    When click on the back arrow from top left in the Order Details screen
    Then verify Order history page is displayed